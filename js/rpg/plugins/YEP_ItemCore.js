 ...
 *
 * @param Max Items
 * @desc 项目的最大数量。如果这个设置为0，
 * 那么将没有独立的项目。
 * @default 0
 *
 * @param Max Weapons
 * @desc 武器的最大数量。如果这个设置为0，
 * 那么将没有独立的武器。
 * @default 100
 *
 * @param Max Armors
 * @desc 盔甲的最大数量。如果这个设置为0，
 * 那么将没有独立的盔甲。
 * @default 100
 *
 * @param Starting ID
 ...
 * @desc 用这个值随机化非商店物品的统计信息，
 * 可以是正值也可以是负值。设置为0表示没有随机。
 * @default 0
 *
 * @param Negative Variance
 * @desc 如果使用随机方差，允许随机方差装备的
 * 统计数字低于0？NO - false YES - true
 * @default false
 *
 * @param Name Format
 * @desc 项目名称将如何排序和结构化。
 * %1 - 前缀, %2 - 基本名称, %3 - 后缀, %4 促进因素
 * @default %1%2%3%4
 *
 * @param Name Spacing
 * @desc 在名字的前缀和后缀之间放一个空格？
 * NO - false     YES - true
 * @default true
 *
 * @param Boost Format
 * @desc 这是一个提升的独立项目的文本格式。
 * %1 - Boost Amount
 * @default (+%1)
 *
 * @param ---Item Scene---
 ...
 * @desc 允许在游戏中期进行音符解析还是在开始时进行？
 * NO - false YES - true 建议: false
 * @default false
 *
 * @help
 * ============================================================================
