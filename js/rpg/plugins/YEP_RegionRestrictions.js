...
//=============================================================================
 /*:
 * @plugindesc v1.04 使用区域来阻挡事件和/或玩家
 * 能够冒险进入那些地方。
 ...
 * ============================================================================
 *
 * 并不是所有人都希望NPC到处旅行。用这个插件,
 * 你可以设置NPC无法移动被指定标记的贴图
 * 区域ID。简单地画出你想要包围NPC的区域
 * 他们将无法通过它，除非他们通过。同样的,
 * 你也可以阻止玩家进入某些区域!
 *
 * RPG Maker VX Ace版本的一个新变化是现在已经存在了
 * 玩家和事件总是可以穿越的区域。
 *
 * ============================================================================
 * Notetags
